...
urlpatterns = [
    ...
    url(r'^genome-choice/(?P<project_pk>[0-9]+)/$', setup_views.genome_selection_page),
    url(r'^set-genome/(?P<project_pk>[0-9]+)/$', setup_views.set_genome),
    ...
    url(r'^notify/', setup_views.notify),
